...
[trivial | intro v1_diff_v1; apply False_rec; apply v1_diff_v1; reflexivity].
left; trivial.
right; left; trivial.
...
generalize (X.eq_bool_ok v1 v1); case (X.eq_bool v1 v1); [intros _; exact I | intro v1_diff_v1; apply False_rec; apply v1_diff_v1; reflexivity].
left; left; destruct l1 as [ | u1 [ | u2 l1]]; [contradiction | intuition | idtac];
simpl; apply list_permut_occurs_in_term_list with (u1 :: u2 :: l1); trivial;
apply quick_permut.
left; right; trivial.
