...
intros _; reflexivity.
intros v_not_le_v; apply False_rec; apply v_not_le_v; apply Rv.
intros f l l_le_l; simpl.
generalize (F.Symb.eq_bool_ok f f); case (F.Symb.eq_bool f f); 
[intros _ | intro f_diff_f; apply False_rec; apply f_diff_f; reflexivity].
rewrite <- o_term_list_is_o_term_list; assumption.
fix 1; intro l; case l; clear l.
intros _; reflexivity.
intros t l H; simpl.
generalize (T1.eq_bool_ok t t); case (T1.eq_bool t t); [intros _ | intro t_diff_t; apply False_rec; apply t_diff_t; reflexivity].
apply o_proof.
...
intros _; reflexivity.
intro x1_not_le_x3; apply False_rec; apply x1_not_le_x3; apply Tv with x2; assumption.
intros; discriminate.
intros; discriminate.
intros; discriminate.
...
generalize (F.Symb.eq_bool_ok f1 f3); case (F.Symb.eq_bool f1 f3); [intro f1_eq_f3; apply False_rec; apply f1_diff_f2 | intros _]; assumption.
intros f1_le_f2 f2_le_f3; generalize (F.Symb.eq_bool_ok f1 f3); case (F.Symb.eq_bool f1 f3); [intro f1_eq_f3 | intro f1_diff_f3].
subst f3; apply False_rec; apply f1_diff_f2; apply As.
...
reflexivity.
apply False_rec; apply f1_not_le_f3; apply Ts with f2.
generalize (OF1.o_bool_ok f1 f2); rewrite f1_le_f2; intro; assumption.
...
[intro t1_eq_t3; apply False_rec; apply t1_diff_t2; apply t1_eq_t3 | intros _; assumption].
intros t1_le_t2 t2_le_t3; generalize (T1.eq_bool_ok t1 t3); case (T1.eq_bool t1 t3); [intro t1_eq_t3 | intros t1_diff_t3].
subst t3; apply False_rec; apply t1_diff_t2.
