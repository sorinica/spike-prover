...
val insert_sorted_dup : ('a -> 'a -> bool) -> ('a -> 'a -> bool) -> 'a -> 'a list -> 'a list 
...
val list_replace_element2 : ('a -> 'a -> bool) -> 'a -> 'a list -> 'a list
val replace_sorted_list :
  ('a -> 'a -> bool) -> ('a -> 'a -> bool) -> 'a -> 'a list -> 'a list 
...
(* "%a" helpers *)
(* ---------------------------------------------------------------------- *)
val pprinter : #printable_object pprinter      (* useful with Format.fprintf "%a" *)
val fprinter : #printable_object fprinter      (* useful with Printf.fprintf "%a" *)
val sprinter : #printable_object sprinter      (* useful with Printf.sprintf "%a" *)

(* ====================================================================== *)
(* autonomous helpers *)
(* ---------------------------------------------------------------------- *)
val pprint : Format.formatter -> #printable_object -> unit     (* pprint and flush *)

val fprint : out_channel      -> #printable_object -> unit     (* pprint to channel
*)
val sprint :                     #printable_object -> string   (* pprint to string *)

val print  : #printable_object -> unit                         (* pprint to stdout *)

val eprint : #printable_object -> unit                         (* pprint to stderr *)

  val resolution :
    (< build : (< both_sides : (< syntactic_equal : 'c -> bool; .. > as 'c) *
                               'c;
                  is_diff : bool; syntactic_equal : 'b -> bool; .. > as 'b)
               list ->
               (< syntactic_equal : 'd -> bool; .. > as 'd) list -> 'a;
       content : 'b list * 'd list; string : string;
       syntactic_equal : 'a -> bool; .. > as 'a)
