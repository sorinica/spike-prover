...
Require Import sorted_insat1_spec.
...
Definition F_309 : type_LF_309:= (fun   u1 u2 u3 _ _ => ((sortedT u1) = true -> (sortedT (insAt u1 u2 u3)) = true, (Term id_sortedT ((model_PLAN u1)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_insAt ((model_PLAN u1):: (model_nat u2):: (model_nat u3)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_340 : type_LF_309:= (fun    _ u2 u3 _ _ => ((sortedT Nil) = true -> (sortedT (Cons (C u2 u3) Nil)) = true, (Term id_sortedT ((Term id_Nil nil)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u2):: (model_nat u3)::nil)):: (Term id_Nil nil)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_355 : type_LF_309:= (fun    _  _ _ _ _ => ((sortedT Nil) = true -> true = true, (Term id_sortedT ((Term id_Nil nil)::nil))::(Term id_true nil)::(Term id_true nil)::(Term id_true nil)::nil)).
Definition F_346 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((sortedT (Cons (C u8 u9) u6)) = true -> (le (time (C u8 u9)) u2) = true -> (sortedT (Cons (C u2 u3) (Cons (C u8 u9) u6))) = true, (Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::(Term id_true nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u8):: (model_nat u9)::nil))::nil)):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u2):: (model_nat u3)::nil)):: (Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::nil))::(Term id_true nil)::nil)).
Definition F_352 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((sortedT (Cons (C u8 u9) u6)) = true -> (le (time (C u8 u9)) u2) = false -> (sortedT (insAt u6 u2 u3)) = true, (Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::(Term id_true nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u8):: (model_nat u9)::nil))::nil)):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_sortedT ((Term id_insAt ((model_PLAN u6):: (model_nat u2):: (model_nat u3)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_358 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((sortedT (Cons (C u8 u9) u6)) = true -> (le u8 u2) = true -> (sortedT (Cons (C u2 u3) (Cons (C u8 u9) u6))) = true, (Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::(Term id_true nil)::(Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u2):: (model_nat u3)::nil)):: (Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::nil))::(Term id_true nil)::nil)).
Definition F_383 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((le u8 u2) = true -> (sortedT u6) = true -> (le (timel u6) (time (C u8 u9))) = true -> (sortedT (Cons (C u2 u3) (Cons (C u8 u9) u6))) = true, (Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((model_PLAN u6)::nil))::(Term id_true nil)::(Term id_le ((Term id_timel ((model_PLAN u6)::nil)):: (Term id_time ((Term id_C ((model_nat u8):: (model_nat u9)::nil))::nil))::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u2):: (model_nat u3)::nil)):: (Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::nil))::(Term id_true nil)::nil)).
Definition F_361 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((sortedT (Cons (C u8 u9) u6)) = true -> (le u8 u2) = false -> (sortedT (insAt u6 u2 u3)) = true, (Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::(Term id_true nil)::(Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_sortedT ((Term id_insAt ((model_PLAN u6):: (model_nat u2):: (model_nat u3)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_408 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((le u8 u2) = false -> (sortedT u6) = true -> (le (timel u6) (time (C u8 u9))) = true -> (sortedT (insAt u6 u2 u3)) = true, (Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_sortedT ((model_PLAN u6)::nil))::(Term id_true nil)::(Term id_le ((Term id_timel ((model_PLAN u6)::nil)):: (Term id_time ((Term id_C ((model_nat u8):: (model_nat u9)::nil))::nil))::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_insAt ((model_PLAN u6):: (model_nat u2):: (model_nat u3)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_386 : type_LF_309:= (fun   u6 u2 u3 u8 u9 => ((le u8 u2) = true -> (sortedT u6) = true -> (le (timel u6) u8) = true -> (sortedT (Cons (C u2 u3) (Cons (C u8 u9) u6))) = true, (Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((model_PLAN u6)::nil))::(Term id_true nil)::(Term id_le ((Term id_timel ((model_PLAN u6)::nil)):: (model_nat u8)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u2):: (model_nat u3)::nil)):: (Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::nil))::(Term id_true nil)::nil)).
Definition F_464 : type_LF_309:= (fun   u6 u2 u8 u9 _ => ((le u8 u2) = true -> (sortedT u6) = true -> (le (timel u6) u8) = true -> (le u8 u2) = true -> (sortedT (Cons (C u8 u9) u6)) = true, (Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((model_PLAN u6)::nil))::(Term id_true nil)::(Term id_le ((Term id_timel ((model_PLAN u6)::nil)):: (model_nat u8)::nil))::(Term id_true nil)::(Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((Term id_Cons ((Term id_C ((model_nat u8):: (model_nat u9)::nil)):: (model_PLAN u6)::nil))::nil))::(Term id_true nil)::nil)).
Definition F_468 : type_LF_309:= (fun   u6 u2 u8 _ _ => ((le u8 u2) = true -> (sortedT u6) = true -> (le (timel u6) u8) = true -> (le u8 u2) = false -> false = true, (Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_sortedT ((model_PLAN u6)::nil))::(Term id_true nil)::(Term id_le ((Term id_timel ((model_PLAN u6)::nil)):: (model_nat u8)::nil))::(Term id_true nil)::(Term id_le ((model_nat u8):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_false nil)::(Term id_true nil)::nil)).

Definition LF_309 := [F_309, F_340, F_355, F_346, F_352, F_358, F_383, F_361, F_408, F_386, F_464, F_468].
...
assert (HFabs1 : fst (F_355 Nil 0 0 0 0)).
...
apply Res. trivial_in 7. unfold snd. unfold F_361. unfold F_352. rewrite_model. abstract solve_rpo_mul.
...
rename u1 into _u6. rename u2 into _u2. rename u3 into _u3. rename u4 into _u8. rename u5 into _u9. 
rename _u6 into u6. rename _u2 into u2. rename _u3 into u3. rename _u8 into u8. rename _u9 into u9. 
assert (H := Hind F_383). clear Hind.
assert (HFabs0: fst (F_383 u6 u2 u3 u8 u9)).
apply H. trivial_in 6. unfold snd. unfold F_358. unfold F_383. rewrite_model. abstract solve_rpo_mul.

unfold fst. unfold F_358.
...
rename u1 into _u6. rename u2 into _u2. rename u3 into _u3. rename u4 into _u8. rename u5 into _u9. 
rename _u6 into u6. rename _u2 into u2. rename _u3 into u3. rename _u8 into u8. rename _u9 into u9. 
assert (Res := Hind F_386). clear Hind.
assert (HFabs1 : fst (F_386 u6 u2 u3 u8 u9)).
apply Res. trivial_in 9. unfold snd. unfold F_386. unfold F_383. rewrite_model. abstract solve_rpo_mul.
unfold fst. unfold F_383. unfold fst in HFabs1. unfold F_386 in HFabs1.   
pattern u8, u9. simpl (time _). cbv beta.
 simpl. auto.
...
rename u1 into _u6. rename u2 into _u2. rename u3 into _u3. rename u4 into _u8. rename u5 into _u9. 
rename _u6 into u6. rename _u2 into u2. rename _u3 into u3. rename _u8 into u8. rename _u9 into u9. 
assert (H := Hind F_408). clear Hind.
assert (HFabs0: fst (F_408 u6 u2 u3 u8 u9)).
apply H. trivial_in 8. unfold snd. unfold F_361. unfold F_408. rewrite_model. abstract solve_rpo_mul.

unfold fst. unfold F_361.
...
assert (HFabs1 : fst (F_309 u6 u2 u3 0 0)).
apply Res. trivial_in 0. unfold snd. unfold F_309. unfold F_408. rewrite_model. abstract solve_rpo_mul.
unfold fst. unfold F_408. unfold fst in HFabs1. unfold F_309 in HFabs1.   
pattern u8, u9. simpl (time _). cbv beta.
 simpl. auto.



	(* TOTAL CASE REWRITING on [ 386 ] *)
...
assert (H1 := Hind F_464). clear Hind.
assert (HFabs0 : fst (F_464 u6 u2 u8 u9 0)).
apply H1. trivial_in 10. unfold snd. unfold F_464. unfold F_386. rewrite_model. abstract solve_rpo_mul.
unfold fst. unfold F_386. unfold F_464. unfold fst in HFabs0. unfold F_464 in HFabs0. simpl in HFabs0. 
pattern u8.
pattern u2.
pattern u3.
pattern u9.
...
assert (H1 := Hind F_468). clear Hind.
assert (HFabs0 : fst (F_468 u6 u2 u8 0 0)).
apply H1. trivial_in 11. unfold snd. unfold F_468. unfold F_386. rewrite_model. abstract solve_rpo_mul.
unfold fst. unfold F_386. unfold F_468. unfold fst in HFabs0. unfold F_468 in HFabs0. simpl in HFabs0. 
pattern u8.
pattern u2.
pattern u3.
pattern u9.
...
rename u1 into _u6. rename u2 into _u2. rename u3 into _u8. rename u4 into _u9. rename u5 into d_u5. 
rename _u6 into u6. rename _u2 into u2. rename _u8 into u8. rename _u9 into u9. 
unfold fst. unfold F_464. specialize true_272 with (u1 := u6) (u2 := u8) (u3 := u9).
(auto || symmetry; auto).
...
rename u1 into _u6. rename u2 into _u2. rename u3 into _u8. rename u4 into d_u4. rename u5 into d_u5. 
rename _u6 into u6. rename _u2 into u2. rename _u8 into u8. 
unfold fst. unfold F_468. specialize true_159 with (u1 := u8) (u2 := u2). intro L. intros. contradict L. (auto || symmetry; auto).
...
Theorem true_309: forall (u1: PLAN) (u2: nat) (u3: nat), (sortedT u1) = true -> (sortedT (insAt u1 u2 u3)) = true.
Proof.
do 3 intro.
