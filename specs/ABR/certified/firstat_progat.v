...
Require Import firstat_progat_spec.
...
Definition F_194 : type_LF_194:= (fun   u1 u2 _ _ => ((er (firstAt u1 u2)) = (progAt u1 u2), (Term id_er ((Term id_firstAt ((model_PLAN u1):: (model_nat u2)::nil))::nil))::(Term id_progAt ((model_PLAN u1):: (model_nat u2)::nil))::nil)).
Definition F_207 : type_LF_194:= (fun    _ u2 _ _ => ((er (firstAt Nil u2)) = 0, (Term id_er ((Term id_firstAt ((Term id_Nil nil):: (model_nat u2)::nil))::nil))::(Term id_0 nil)::nil)).
Definition F_213 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le (time (C u6 u7)) u2) = true -> (er (firstAt (Cons (C u6 u7) u5) u2)) = (er (C u6 u7)), (Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_firstAt ((Term id_Cons ((Term id_C ((model_nat u6):: (model_nat u7)::nil)):: (model_PLAN u5)::nil)):: (model_nat u2)::nil))::nil))::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::nil)).
Definition F_219 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le (time (C u6 u7)) u2) = false -> (er (firstAt (Cons (C u6 u7) u5) u2)) = (progAt u5 u2), (Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_firstAt ((Term id_Cons ((Term id_C ((model_nat u6):: (model_nat u7)::nil)):: (model_PLAN u5)::nil)):: (model_nat u2)::nil))::nil))::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_222 : type_LF_194:= (fun    _  _ _ _ => ((er (C 0 0)) = 0, (Term id_er ((Term id_C ((Term id_0 nil):: (Term id_0 nil)::nil))::nil))::(Term id_0 nil)::nil)).
Definition F_232 : type_LF_194:= (fun    _  _ _ _ => (0 = 0, (Term id_0 nil)::(Term id_0 nil)::nil)).
Definition F_225 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = true -> (er (firstAt (Cons (C u6 u7) u5) u2)) = (er (C u6 u7)), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_firstAt ((Term id_Cons ((Term id_C ((model_nat u6):: (model_nat u7)::nil)):: (model_PLAN u5)::nil)):: (model_nat u2)::nil))::nil))::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::nil)).
Definition F_229 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = false -> (er (firstAt (Cons (C u6 u7) u5) u2)) = (progAt u5 u2), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_firstAt ((Term id_Cons ((Term id_C ((model_nat u6):: (model_nat u7)::nil)):: (model_PLAN u5)::nil)):: (model_nat u2)::nil))::nil))::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_247 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = false -> (le (time (C u6 u7)) u2) = true -> (er (C u6 u7)) = (progAt u5 u2), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_251 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = false -> (le (time (C u6 u7)) u2) = false -> (er (firstAt u5 u2)) = (progAt u5 u2), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_firstAt ((model_PLAN u5):: (model_nat u2)::nil))::nil))::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_254 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = false -> (le u6 u2) = true -> (er (C u6 u7)) = (progAt u5 u2), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_260 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = false -> (le u6 u2) = true -> u7 = (progAt u5 u2), (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(model_nat u7)::(Term id_progAt ((model_PLAN u5):: (model_nat u2)::nil))::nil)).
Definition F_235 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = true -> (er (firstAt (Cons (C u6 u7) u5) u2)) = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_firstAt ((Term id_Cons ((Term id_C ((model_nat u6):: (model_nat u7)::nil)):: (model_PLAN u5)::nil)):: (model_nat u2)::nil))::nil))::(model_nat u7)::nil)).
Definition F_273 : type_LF_194:= (fun    _ u2 u6 u7 => ((le u6 u2) = true -> (le (time (C u6 u7)) u2) = true -> (er (C u6 u7)) = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::(model_nat u7)::nil)).
Definition F_277 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = true -> (le (time (C u6 u7)) u2) = false -> (er (firstAt u5 u2)) = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_le ((Term id_time ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil)):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_firstAt ((model_PLAN u5):: (model_nat u2)::nil))::nil))::(model_nat u7)::nil)).
Definition F_280 : type_LF_194:= (fun    _ u2 u6 u7 => ((le u6 u2) = true -> (le u6 u2) = true -> (er (C u6 u7)) = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u6):: (model_nat u7)::nil))::nil))::(model_nat u7)::nil)).
Definition F_286 : type_LF_194:= (fun    _ u2 u6 u7 => ((le u6 u2) = true -> (le u6 u2) = true -> u7 = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(model_nat u7)::(model_nat u7)::nil)).
Definition F_283 : type_LF_194:= (fun   u5 u2 u6 u7 => ((le u6 u2) = true -> (le u6 u2) = false -> (er (firstAt u5 u2)) = u7, (Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_le ((model_nat u6):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_firstAt ((model_PLAN u5):: (model_nat u2)::nil))::nil))::(model_nat u7)::nil)).

Definition LF_194 := [F_194, F_207, F_213, F_219, F_222, F_232, F_225, F_229, F_247, F_251, F_254, F_260, F_235, F_273, F_277, F_280, F_286, F_283].
...
pattern 0, 0. simpl (er _). cbv beta.
 simpl. auto.
...
assert (HFabs1 : fst (F_260 u5 u2 u6 u7)).
apply Res. trivial_in 11. unfold snd. unfold F_260. unfold F_254. rewrite_model. abstract solve_rpo_mul.
...
rename u1 into _u5. rename u2 into _u2. rename u3 into _u6. rename u4 into _u7. 
rename _u5 into u5. rename _u2 into u2. rename _u6 into u6. rename _u7 into u7. 
unfold fst. unfold F_260. specialize true_156 with (u1 := u6) (u2 := u2). intro L. intros. contradict L. (auto || symmetry; auto).
...
apply H1. trivial_in 14. unfold snd. unfold F_277. unfold F_235. rewrite_model. abstract solve_rpo_mul.
...
apply Res. trivial_in 15. unfold snd. unfold F_280. unfold F_273. rewrite_model. abstract solve_rpo_mul.
...
assert (HFabs1 : fst (F_283 u5 u2 u6 u7)).
apply Res. trivial_in 17. unfold snd. unfold F_283. unfold F_277. rewrite_model. abstract solve_rpo_mul.
unfold fst. unfold F_277. unfold fst in HFabs1. unfold F_283 in HFabs1.   
pattern u6, u7. simpl (time _). cbv beta.
 simpl. auto.
...
assert (HFabs1 : fst (F_286 Nil u2 u6 u7)).
apply Res. trivial_in 16. unfold snd. unfold F_286. unfold F_280. rewrite_model. abstract solve_rpo_mul.
...
rename u1 into _u5. rename u2 into _u2. rename u3 into _u6. rename u4 into _u7. 
rename _u5 into u5. rename _u2 into u2. rename _u6 into u6. rename _u7 into u7. 
unfold fst. unfold F_283. specialize true_156 with (u1 := u6) (u2 := u2). intro L. intros. contradict L. (auto || symmetry; auto).
...
Theorem true_194: forall (u1: PLAN) (u2: nat), (er (firstAt u1 u2)) = (progAt u1 u2).
Proof.
do 2 intro.
