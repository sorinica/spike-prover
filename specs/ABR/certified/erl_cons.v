...
Require Import erl_cons_spec.



Definition type_LF_155 :=  PLAN ->  nat ->  nat ->  nat -> (Prop * (List.list term)).

Definition F_155 : type_LF_155:= (fun   u1 u2 _ _ => ((erl (listUpTo u1 u2)) = (erl u1), (Term id_erl ((Term id_listUpTo ((model_PLAN u1):: (model_nat u2)::nil))::nil))::(Term id_erl ((model_PLAN u1)::nil))::nil)).
Definition F_167 : type_LF_155:= (fun    _  _ _ _ => ((erl Nil) = (erl Nil), (Term id_erl ((Term id_Nil nil)::nil))::(Term id_erl ((Term id_Nil nil)::nil))::nil)).
Definition F_173 : type_LF_155:= (fun   u6 u2 u3 u5 => ((le u3 u2) = true -> (erl (Cons (C u3 u5) Nil)) = (erl (Cons (C u3 u5) u6)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (Term id_Nil nil)::nil))::nil))::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (model_PLAN u6)::nil))::nil))::nil)).
Definition F_179 : type_LF_155:= (fun   u6 u2 u3 u5 => ((le u3 u2) = false -> (erl (Cons (C u3 u5) (listUpTo u6 u2))) = (erl (Cons (C u3 u5) u6)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (Term id_listUpTo ((model_PLAN u6):: (model_nat u2)::nil))::nil))::nil))::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (model_PLAN u6)::nil))::nil))::nil)).
Definition F_182 : type_LF_155:= (fun   u6 u2 u3 u5 => ((le u3 u2) = true -> (er (C u3 u5)) = (erl (Cons (C u3 u5) u6)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (model_PLAN u6)::nil))::nil))::nil)).
Definition F_188 : type_LF_155:= (fun    _ u2 u3 u5 => ((le u3 u2) = true -> (er (C u3 u5)) = (er (C u3 u5)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_true nil)::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::nil)).
Definition F_185 : type_LF_155:= (fun   u6 u2 u3 u5 => ((le u3 u2) = false -> (er (C u3 u5)) = (erl (Cons (C u3 u5) u6)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::(Term id_erl ((Term id_Cons ((Term id_C ((model_nat u3):: (model_nat u5)::nil)):: (model_PLAN u6)::nil))::nil))::nil)).
Definition F_191 : type_LF_155:= (fun    _ u2 u3 u5 => ((le u3 u2) = false -> (er (C u3 u5)) = (er (C u3 u5)), (Term id_le ((model_nat u3):: (model_nat u2)::nil))::(Term id_false nil)::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::(Term id_er ((Term id_C ((model_nat u3):: (model_nat u5)::nil))::nil))::nil)).
...
pattern (C u3 u5), Nil. simpl (erl _). cbv beta.
 simpl. auto.
...
pattern (C u3 u5), (listUpTo u6 u2). simpl (erl _). cbv beta.
 simpl. auto.
...
pattern (C u3 u5), u6. simpl (erl _). cbv beta.
 simpl. auto.
...
Theorem true_155: forall (u1: PLAN) (u2: nat), (erl (listUpTo u1 u2)) = (erl u1).
Proof.
do 2 intro.
