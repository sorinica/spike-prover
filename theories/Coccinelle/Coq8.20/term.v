...
apply le_n_S; apply le_plus_r_stt.
Defined.
...
subst u; trivial.
apply IHl; trivial.
revert Ar; case (arity f); intros; apply beq_nat_eq_stt ; symmetry; assumption.
Qed.            
...
intro Ar; rewrite Ar; symmetry; apply beq_nat_refl_stt; assumption.
intro Ar; rewrite Ar; symmetry; apply beq_nat_refl_stt; assumption.
intros n Ar; rewrite Ar; symmetry; apply beq_nat_refl_stt; assumption.
Qed.            
