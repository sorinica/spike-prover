...
#[export] Instance Acc_incl A : Proper (incl --> eq ==> impl) (@Acc A).

Proof.
  intros R R' R'R x x' xx'. subst x'. induction 1. apply Acc_intro. fo.
Qed.

#[export] Instance Acc_same A : Proper (same ==> eq ==> iff) (@Acc A).
...
#[export] Instance well_founded_incl A :
  Proper (incl --> impl) (@well_founded A).

Proof. intros R R' R'R h. intro x. rewrite <- R'R. fo. Qed.

#[export] Instance well_founded_same A : Proper (same ==> iff) (@well_founded A).
