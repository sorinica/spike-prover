...
From Coq Require Import Morphisms Psatz Compare Euclid.
...
#[export] Instance lt_trans : Transitive lt. 

Proof. intro; lia. Qed.

#[export] Instance ge_preorder : PreOrder ge.

Proof. split; intro; lia. Qed.

#[export] Instance gt_trans : Transitive gt.
...
Proof.
  induction x; destruct y; simpl; split; intro; try lia; try discr. rewrite IHx in H. lia.
  rewrite IHx. lia.
Qed.
