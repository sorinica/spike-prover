...
From Coq Require Import Setoid Basics Morphisms List.
...
(** Properties of [incl]. *)
 ...
 #[export] Instance incl_refl A : Reflexive (@incl A).

Proof. fo. Qed.

Ltac incl_refl := apply incl_refl.

#[export] Instance incl_trans A : Transitive (@incl A).

Proof. fo. Qed.

Ltac incl_trans S := apply incl_trans with S; try incl_refl.

#[export] Instance incl_same A : Proper (same ==> same ==> impl) (@incl A).
...
#[export] Instance same_equiv A : Equivalence (@same A).
...
#[export] Instance refl_same A : Proper (same ==> impl) (@Reflexive A).

Proof. fo. Qed.

#[export] Instance sym_same A : Proper (same ==> impl) (@Symmetric A).

Proof. fo. Qed.

#[export] Instance trans_same A : Proper (same ==> impl) (@Transitive A).
...
#[export] Instance equiv_same A : Proper (same ==> impl) (@Equivalence A).
...
#[export] Instance prop_rel_same A (E : rel A) :
...
#[export] Instance equiv_prop A (R : rel A) : 	 
...
#[export] Instance IS_incl A : Proper (incl ==> Logic.eq ==> impl) (@IS A).

Proof. intros R S RS f g fg h i. subst. fo. Qed.

#[export] Instance IS_same A : Proper (same ==> Logic.eq ==> impl) (@IS A).

Proof. intros R S RS f g fg h. subst. fo. Qed.

#[export] Instance EIS_same A : Proper (same ==> impl) (@EIS A).
...
#[export] Instance irreflexive_incl A : Proper (incl --> impl) (@irreflexive A).
...
#[export] Instance compose_incl A : Proper (incl ==> incl ==> incl) (@compose A).
...
#[export] Instance compose_same A : Proper (same ==> same ==> same) (@compose A).
...
#[export] Instance union_incl A : Proper (incl ==> incl ==> incl) (@union A).
...
#[export] Instance union_same A : Proper (same ==> same ==> same) (@union A).
...
#[export] Instance rc_incl A : Proper (incl ==> incl) (@clos_refl A).

Proof. fo. Qed.

#[export] Instance rc_same A : Proper (same ==> same) (@clos_refl A).

Proof. fo. Qed.

#[export] Instance rc_refl A (R : rel A) : Reflexive (R%).

Proof. fo. Qed.

#[export] Instance rc_trans A (R : rel A) : Transitive R -> Transitive (R%).
...
#[export] Instance tc_trans A (R : rel A) : Transitive (R!).

Proof. unfold Transitive. intros. apply t_trans with y; hyp. Qed.

#[export] Instance tc_incl A : Proper (incl ==> incl) (@clos_trans A).
...
#[export] Instance tc_same A : Proper (same ==> same) (@clos_trans A).
...
#[export] Instance tc_prop A (E R : rel A) : Reflexive E ->
...
#[export] Instance ec_incl A : Proper (incl ==> incl) (@clos_equiv A).
...
#[export] Instance rtc_refl A (R : rel A) : Reflexive (R#).

Proof. unfold Reflexive. apply rt_refl. Qed.

#[export] Instance rtc_trans A (R : rel A) : Transitive (R#).

Proof. unfold Transitive. intros. eapply rt_trans. apply H. hyp. Qed.

#[export] Instance rtc_incl A : Proper (incl ==> incl) (@clos_refl_trans A).
...
#[export] Instance rtc_same A : Proper (same ==> same) (@clos_refl_trans A).
...
#[export] Instance rtc_sym A (R : rel A) : Symmetric R -> Symmetric (R#).
...
#[export] Instance transp_incl A : Proper (incl ==> incl) (@transp A).

Proof. fo. Qed.

#[export] Instance transp_same A : Proper (same ==> same) (@transp A).

Proof. fo. Qed.

(*COQ: declaring these lemmas as Global #[export] Instance makes Coq loop
...
#[export] Instance Rof_incl A B : Proper (incl ==> Logic.eq ==> incl) (@Rof A B).
...
#[export] Instance tc1_trans A (R : rel A) : Transitive (R!1).
...
#[export] Instance rtc1_preorder A (R : rel A) : PreOrder (R#1).
...
#[export] Instance opt_incl A : Proper (incl ==> incl) (@opt A).

Proof.
  intros R S RS x y xy. inversion xy; clear xy; subst. apply opt_intro. fo.
Qed.

#[export] Instance opt_prop A (E1 E2 R : rel A) :
